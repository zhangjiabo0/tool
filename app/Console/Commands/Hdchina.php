...
class Hdchina extends Command
{
     ...
     * @var string
     */
    protected $description = 'hdchina 推广赚蓝光币';
    ...
    public function handle()
    {
        for($i = 0;$i<20;$i++){
            ...
            Http::withHeaders($arr)->connectTimeout(60)->get('https://www.hdchina.net/?fromuid=102897');
            echo $i.' end:'.PHP_EOL;
            sleep(10);
        }
    }
